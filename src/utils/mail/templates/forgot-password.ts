...
export default function forgotPasswordTemplate(props: VerifyEmailTemplateProps) {

    const path = process.env.NODE_ENV === 'development' ? 'http://localhost:3000/auth/forgot-password/' : 'https://clone-tabnews.com.br/auth/forgot-password/';
                ...
                <table role="presentation" style="max-width: 600px; border-collapse: collapse; border: 0px; border-spacing: 0px; text-align: left;">
                    ...
                    <tr>
                        ...
                        <div style="padding: 20px; background-color: rgb(255, 255, 255);">
                            ...
                            <h1 style="margin: 1rem 0">Recuperar Senha</h1>
                            <p style="padding-bottom: 16px font-size: 12px; color: #444;">Não compartilhe este email ou link</p>
